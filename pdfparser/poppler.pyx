    ...
    def _get_text(self):
        ...
        while w:
            ...
            for i in range(wlen):
                ...
                last_font=FontInfo(font_name.getCString().decode('UTF-8', 'replace') if <unsigned long>font_name != 0 else u"unknown", # In rare cases font name is not UTF-8 or the returned string can be NULL
                                   w.getFontSize(),
                                   Color(r,g,b)
                                   )
